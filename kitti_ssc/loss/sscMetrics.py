...
class SSCMetrics:
    ...
    def get_stats(self):
        self.completion_tp = self.reduce_ddp(self.completion_tp)
        self.completion_fp = self.reduce_ddp(self.completion_fp)
        self.completion_fn = self.reduce_ddp(self.completion_fn)
        ...
        self.tps = self.reduce_ddp(self.tps)
        self.fps = self.reduce_ddp(self.fps)
        self.fns = self.reduce_ddp(self.fns)
