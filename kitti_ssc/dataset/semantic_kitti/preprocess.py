...
import glob
import sys
sys.path.insert(0, os.path.abspath(os.path.join(os.path.abspath(__file__), os.pardir, os.pardir, os.pardir, os.pardir)))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--kitti_preprocess_root', type=str, default='data/kitti/preprocess_ssc')
